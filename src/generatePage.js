...
<div class="container">
  ...
  <div class="toolbar">
    ...
    <a href="./latest-digest.pptx" download style="display:inline-block;background:var(--blue);color:white;border:none;padding:10px 20px;border-radius:8px;font-size:14px;font-weight:600;text-decoration:none;cursor:pointer;">📊 下載簡報 (.pptx)</a>
  </div>
